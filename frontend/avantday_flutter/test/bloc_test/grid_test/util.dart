import 'package:avantday/plugins/database_view/application/cell/cell_controller.dart';
...
import 'package:avantday/plugins/database_view/application/field/field_editor_bloc.dart';
import 'package:avantday/plugins/database_view/application/field/field_service.dart';
import 'package:avantday/plugins/database_view/application/field/type_option/type_option_context.dart';
import 'package:avantday/plugins/database_view/application/row/row_cache.dart';
import 'package:avantday/plugins/database_view/application/row/row_data_controller.dart';
import 'package:avantday/plugins/database_view/grid/application/grid_data_controller.dart';
import 'package:avantday/plugins/database_view/grid/application/row/row_bloc.dart';
import 'package:avantday/plugins/database_view/grid/grid.dart';
import 'package:avantday/workspace/application/app/app_service.dart';
...
class AvantdayGridTest {
  final AvantdayUnitTest unitTest;

  AvantdayGridTest({required this.unitTest});

  static Future<AvantdayGridTest> ensureInitialized() async {
    final inner = await AvantdayUnitTest.ensureInitialized();
    return AvantdayGridTest(unitTest: inner);
  }
...
class AvantdayGridCellTest {
  late GridTestContext context;
  final AvantdayGridTest gridTest;
  AvantdayGridCellTest({required this.gridTest});

  static Future<AvantdayGridCellTest> ensureInitialized() async {
    final gridTest = await AvantdayGridTest.ensureInitialized();
    return AvantdayGridCellTest(gridTest: gridTest);
  }
