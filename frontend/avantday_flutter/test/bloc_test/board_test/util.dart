...
import 'package:avantday/plugins/database_view/board/application/board_data_controller.dart';
...
class AvantdayBoardTest {
  final AvantdayUnitTest unitTest;

  AvantdayBoardTest({required this.unitTest});

  static Future<AvantdayBoardTest> ensureInitialized() async {
    final inner = await AvantdayUnitTest.ensureInitialized();
    return AvantdayBoardTest(unitTest: inner);
  }
