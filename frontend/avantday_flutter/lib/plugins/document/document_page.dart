import 'package:avantday/plugins/document/presentation/plugins/board/board_menu_item.dart';
import 'package:avantday/plugins/document/presentation/plugins/board/board_node_widget.dart';
import 'package:avantday/plugins/document/presentation/plugins/cover/cover_node_widget.dart';
import 'package:avantday/plugins/document/presentation/plugins/grid/grid_menu_item.dart';
import 'package:avantday/plugins/document/presentation/plugins/grid/grid_node_widget.dart';
import 'package:avantday/plugins/document/presentation/plugins/openai/widgets/auto_completion_node_widget.dart';
import 'package:avantday/plugins/document/presentation/plugins/openai/widgets/auto_completion_plugins.dart';
import 'package:avantday/plugins/document/presentation/plugins/openai/widgets/smart_edit_node_widget.dart';
import 'package:avantday/plugins/document/presentation/plugins/openai/widgets/smart_edit_toolbar_item.dart';
import 'package:avantday_backend/protobuf/flowy-folder/view.pb.dart';
import 'package:avantday_editor/avantday_editor.dart';
import 'package:avantday_editor_plugins/avantday_editor_plugins.dart';
...
class _DocumentPageState extends State<DocumentPage> {
  ...
  @override
  void initState() {
    // The avantday editor use Intl as localization, set the default language as fallback.
...
class _AvantdayEditorPage extends StatefulWidget {
  const _AvantdayEditorPage({
    Key? key,
  }) : super(key: key);

  @override
  State<_AvantdayEditorPage> createState() => _AvantdayEditorPageState();
}

class _AvantdayEditorPageState extends State<_AvantdayEditorPage> {
  late DocumentBloc documentBloc;
