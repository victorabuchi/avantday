...
class BoardBloc extends Bloc<BoardEvent, BoardState> {
  ...
  late final AvantdayBoardController boardController;
  ...
  BoardBloc({required ViewPB view})
    ...
    boardController = AvantdayBoardController(
      onMoveGroup: (
        fromGroupId,
        fromIndex,
        toGroupId,
  ...
  List<AvantdayGroupItem> _buildGroupItems(GroupPB group) {
    ...
    return <AvantdayGroupItem>[...items];
  }
  ...
  AvantdayGroupData initializeGroupData(GroupPB group) {
    return AvantdayGroupData(
      id: group.groupId,
      name: group.desc,
...
class GroupItem extends AvantdayGroupItem {
  final RowPB row;
...
class GroupControllerDelegateImpl extends GroupControllerDelegate {
  ...
  final AvantdayBoardController controller;
