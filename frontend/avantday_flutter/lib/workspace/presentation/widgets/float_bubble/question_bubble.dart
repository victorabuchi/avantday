import 'package:avantday/startup/tasks/rust_sdk.dart';
        ...
        if (action is BubbleActionWrapper) {
          switch (action.inner) {
            case BubbleAction.whatsNews:
              _launchURL("https://www.avantday.io/whatsnew");
              break;
            ...
            case BubbleAction.shortcuts:
              _launchURL(
                  "https://github.com/Avantday-IO/Avantday-Docs/blob/main/essential-documentation/shortcuts.md");
              break;
          }
        }
