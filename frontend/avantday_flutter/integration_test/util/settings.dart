...
import 'package:avantday/workspace/presentation/settings/settings_dialog.dart';
...
extension AvantdaySettings on WidgetTester {
  /// Open settings page
  ...
  /// Restore the Avantday data storage location
