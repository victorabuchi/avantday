...
import 'package:avantday/main.dart' as app;
import 'package:avantday/startup/tasks/prelude.dart';
...
class TestFolder {
  ...
  /// Set a given Avantday data storage location under test environment.
  ///
...
extension AvantdayTestBase on WidgetTester {
  Future<void> initializeAvantday() async {
