import 'package:avantday/user/presentation/folder/folder_widget.dart';
...
void main() {
  ...
  group('customize the folder path', () {
    ...
    testWidgets(
        ...
        (tester) async {
      const folderName = 'avantday';
      await TestFolder.cleanTestLocation(folderName);

      await tester.initializeAvantday();
      ...
      await tester.enterText(ftf, 'avantday');
