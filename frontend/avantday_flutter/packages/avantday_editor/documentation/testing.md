...
Update the [Selection](https://github.com/Avantday-IO/Avantday/blob/main/frontend/avantday_flutter/packages/avantday_editor/lib/src/document/selection.dart) so that our text "Welcome to Appflowy 😁" is selected. We will start our selection from the beginning of the string.
