...
Now our 'underscore handler' function is done and the only task left is to inject it into the AvantdayEditor.
...
Check out the [complete code](https://github.com/Avantday-IO/Avantday/blob/main/frontend/avantday_flutter/packages/avantday_editor/lib/src/service/internal_key_event_handlers/markdown_syntax_to_styled_text.dart) file of this example.
...
... and register `NetworkImageNodeWidgetBuilder` in the `AvantdayEditor`.
...
Check out the [complete code](https://github.com/Avantday-IO/Avantday/blob/main/frontend/avantday_flutter/packages/avantday_editor/example/lib/plugin/network_image_node_widget.dart) file of this example.
...
Now our 'customize style' function is done and the only task left is to inject it into the AvantdayEditor.
