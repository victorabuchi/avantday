...
import 'package:avantday_editor/src/infra/log.dart';
import 'package:avantday_editor/src/service/context_menu/built_in_context_menu_item.dart';
...
import 'package:avantday_editor/src/core/document/node_iterator.dart';
import 'package:avantday_editor/src/core/document/path.dart';
import 'package:avantday_editor/src/core/location/position.dart';
import 'package:avantday_editor/src/core/location/selection.dart';
import 'package:avantday_editor/src/editor_state.dart';
import 'package:avantday_editor/src/extensions/node_extensions.dart';
import 'package:avantday_editor/src/extensions/object_extensions.dart';
import 'package:avantday_editor/src/render/selection/cursor_widget.dart';
import 'package:avantday_editor/src/render/selection/selectable.dart';
import 'package:avantday_editor/src/render/selection/selection_widget.dart';
import 'package:avantday_editor/src/service/selection/selection_gesture.dart';

/// [AvantdaySelectionService] is responsible for processing
...
/// ```
///
abstract class AvantdaySelectionService {
...
class AvantdaySelection extends StatefulWidget {
  const AvantdaySelection({
    Key? key,
  ...
  @override
  State<AvantdaySelection> createState() => _AvantdaySelectionState();
}

class _AvantdaySelectionState extends State<AvantdaySelection>
    with WidgetsBindingObserver
    implements AvantdaySelectionService {
