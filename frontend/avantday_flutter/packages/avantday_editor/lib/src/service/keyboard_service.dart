...
/// [AvantdayKeyboardService] is responsible for processing shortcut keys,
...
/// ```
///
abstract class AvantdayKeyboardService {
...
class AvantdayKeyboard extends StatefulWidget {
  const AvantdayKeyboard({
    Key? key,
    this.editable = true,
  ...
  @override
  State<AvantdayKeyboard> createState() => _AvantdayKeyboardState();
}

class _AvantdayKeyboardState extends State<AvantdayKeyboard>
    implements AvantdayKeyboardService {
