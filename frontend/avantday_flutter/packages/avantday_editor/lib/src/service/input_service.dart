...
/// [AvantdayInputService] is responsible for processing text input,
...
/// ```
///
abstract class AvantdayInputService {
...
class AvantdayInput extends StatefulWidget {
  const AvantdayInput({
    Key? key,
    this.editable = true,
  ...
  @override
  State<AvantdayInput> createState() => _AvantdayInputState();
}

class _AvantdayInputState extends State<AvantdayInput>
    implements AvantdayInputService, DeltaTextInputClient {
