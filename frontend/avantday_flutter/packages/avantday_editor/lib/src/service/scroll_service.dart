...
/// [AvantdayScrollService] is responsible for processing document scrolling.
///
...
/// ```
///
abstract class AvantdayScrollService {
...
class AvantdayScroll extends StatefulWidget {
  const AvantdayScroll({
    Key? key,
    required this.child,
  }) : super(key: key);
  ...
  @override
  State<AvantdayScroll> createState() => _AvantdayScrollState();
}

class _AvantdayScrollState extends State<AvantdayScroll>
    implements AvantdayScrollService {
