...
import 'package:avantday_editor/src/infra/html_converter.dart';
import 'package:avantday_editor/src/service/internal_key_event_handlers/number_list_helper.dart';
...
void _handlePaste(EditorState editorState) async {
  final data = await AvantdayClipboard.getData();
...
void _pastRichClipboard(EditorState editorState, AvantdayClipboardData data) {
  if (data.html != null) {
