...
final List<SelectionMenuItem> _defaultSelectionMenuItems = [
  SelectionMenuItem(
    name: () => AvantdayEditorLocalizations.current.text,
  ...
  SelectionMenuItem(
    name: () => AvantdayEditorLocalizations.current.heading1,
    icon: (editorState, onSelected) =>
  ...
  SelectionMenuItem(
    name: () => AvantdayEditorLocalizations.current.heading2,
    icon: (editorState, onSelected) =>
  ...
  SelectionMenuItem(
    name: () => AvantdayEditorLocalizations.current.heading3,
    icon: (editorState, onSelected) =>
  ...
  SelectionMenuItem(
    name: () => AvantdayEditorLocalizations.current.image,
    icon: (editorState, onSelected) =>
  ...
  SelectionMenuItem(
    name: () => AvantdayEditorLocalizations.current.bulletedList,
    icon: (editorState, onSelected) =>
  ...
  SelectionMenuItem(
    name: () => AvantdayEditorLocalizations.current.numberedList,
    icon: (editorState, onSelected) =>
  ...
  SelectionMenuItem(
    name: () => AvantdayEditorLocalizations.current.checkbox,
    icon: (editorState, onSelected) =>
  ...
  SelectionMenuItem(
    name: () => AvantdayEditorLocalizations.current.quote,
    icon: (editorState, onSelected) =>
