...
class AvantdayEditorLocalizations {
  AvantdayEditorLocalizations();

  static AvantdayEditorLocalizations? _current;

  static AvantdayEditorLocalizations get current {
    assert(_current != null,
        'No instance of AvantdayEditorLocalizations was loaded. Try to initialize the AvantdayEditorLocalizations delegate before accessing AvantdayEditorLocalizations.current.');
    return _current!;
  }

  static const AppLocalizationDelegate delegate = AppLocalizationDelegate();

  static Future<AvantdayEditorLocalizations> load(Locale locale) {
    ...
    return initializeMessages(localeName).then((_) {
      ...
      final instance = AvantdayEditorLocalizations();
      AvantdayEditorLocalizations._current = instance;

      return instance;
    });
  }

  static AvantdayEditorLocalizations of(BuildContext context) {
    final instance = AvantdayEditorLocalizations.maybeOf(context);
    assert(instance != null,
        'No instance of AvantdayEditorLocalizations present in the widget tree. Did you add AvantdayEditorLocalizations.delegate in localizationsDelegates?');
    return instance!;
  }

  static AvantdayEditorLocalizations? maybeOf(BuildContext context) {
    return Localizations.of<AvantdayEditorLocalizations>(
        context, AvantdayEditorLocalizations);
  }
...
class AppLocalizationDelegate
    extends LocalizationsDelegate<AvantdayEditorLocalizations> {
  ...
  @override
  Future<AvantdayEditorLocalizations> load(Locale locale) =>
      AvantdayEditorLocalizations.load(locale);
  @override
