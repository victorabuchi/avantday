...
/// Manages log service for [AvantdayEditor]
///
...
/// For logging message in AvantdayEditor
class Log {
  Log._({
    required this.name,
  }) : _logger = Logger(name);
  ...
  /// For logging message related to [AvantdayEditor].
  ///
