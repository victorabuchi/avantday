              ...
              "children": [
                {
                  ...
                  "delta": [
                    ...
                    {"insert": " "},
                    {
                      ...
                      "attributes": {"italic": true, "bold": true, "href": "avantday.io"}
                    }
                  ]
                },
                {"type": "text", "delta": []},
...
''';
    ...
    test('parser document', () async {
      const markdown = '''
## 👋 **Welcome to** ***[Avantday Editor](avantday.io)***

Avantday Editor is a **highly customizable** _rich-text editor_
- [x] Customizable
- [x] Test-covered
- [ ] more to come!
...
You can also use ***Avantday Editor*** as a component to build your own app.
